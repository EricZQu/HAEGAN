...
def load_data(args, datapath):
    ...
    data['adj_train_norm'], data['features'] = DataProcess(
...
# ======== HGCN Data Preprocess ========

def DataProcess(adj, features, normalize_adj = True, normalize_feats = False, long_tensor = False):
    if normalize_feats:
